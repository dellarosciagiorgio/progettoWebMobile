...
{#if loginSuccess}
  ...
  <div class="container-fluid min-vh-100 d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);">
    <div class="card text-center shadow-lg rounded-4 p-5 border-0" style="max-width: 600px;">
      <div class="mb-4">
        <div class="position-relative d-inline-block">
          <div class="position-absolute" style="width: 160px; height: 160px; background-color: rgba(40, 167, 69, 0.1); border-radius: 50%; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 0;"></div>
          <img src="/logo.png" alt="Successo" class="img-fluid" style="max-width: 100px; z-index: 1; position: relative;" />
        </div>
      </div>
      <h2 class="fw-bold text-success mb-3">Login avvenuto con successo!</h2>
      <p class="text-muted mb-4">Benvenuto su Sagre Italiane 🎉</p>
      <button class="btn btn-success px-4 py-2 fw-bold" on:click={goToHome}>
        Vai alla Home
      </button>
    </div>
  </div>
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <form on:submit|preventDefault={handleLogin}>
              ...
              <div class="text-center">
                ...
                <a href="/Registrazione" class="fw-bold text-decoration-none" style="color: #d62828;">
                  Registrati ora
                </a>
              </div>
            </form>
